...
Yd();}
function Qh(){var $r=new J();Jc($r);return $r;}
function Rh(b){var $r=new J();Dc($r,b);return $r;}
function Jc($t){J_$callClinit();Dc($t,16);}
...
function Fe($t){Ie($t);}
function Hc(){Eb.call(this);}
function Ug(){var $r=new Hc();Qd($r);return $r;}
function Qd($t){Fe($t);}
...
function Pf(a){var b;if(a>=1073741824){return 1073741824;}if(a==0){return 16;}b=a-1|0;a=b|b>>1;a=a|a>>2;a=a|a>>4;a=a|a>>8;return (a|a>>16)+1|0;}
function Me($t,a,b){Nd($t);if(a>=0&&b>0.0){a=Pf(a);$t.O=0;$t.V=Te($t,a);$t.bb=b;Md($t);return;}Vf(Zh());}
...
function Ae($t,a){var b,c,d,e,f,g,h;b=Pf(a==0?1:a<<1);c=Te($t,b);d=0;b=b-1|0;while(d<$t.V.data.length){e=$t.V.data[d];$t.V.data[d]=null;while(e!==null){f=c.data;g=e.n&b;h=e.Q;e.Q=f[g];f[g]=e;e=h;}d=d+1|0;}$t.V=c;Md($t);}
...
function Ic(){var a=this;Bb.call(a);a.K=false;a.w=null;a.Cb=null;a.J=null;}
function Sg(b,c){var $r=new Ic();Pe($r,b,c);return $r;}
function Pe($t,a,b){Gf($t,a);$t.w=Sh();$t.Cb=$rt_createCharArray(32);$t.K=b;$t.J=Ki();}
function Nc(){E.call(this);}
function Qf(a){var b,c,d;b=Of();c=b.createElement("div");d=b.createTextNode("TeaVM generated element");c.appendChild(d);b.body.appendChild(c);}
function Kc(){O.call(this);}
function Ni(b){var $r=new Kc();Td($r,b);return $r;}
...
{Cd(this,b);}],Q,"java.lang.LinkageError",Db,[],0,0,["b",function(b){Ye(this,b);}],O,"java.lang.IncompatibleClassChangeError",Q,[],0,0,["b",function(b){Oe(this,b);}],Yc,"java.lang.NoSuchFieldError",O,[],0,0,["b",function(b){If(this,b);}],L,"org.teavm.jso.dom.events.EventTarget",E,[M],0,0,[],Ac,"org.teavm.jso.dom.html.HTMLDocument",E,[Ob,L],0,0,[],R,"java.lang.Thread",E,[Wb],0,R_$callClinit,["b",function(b){Rc(this,b);},"kb",function(b,c){Oc(this,b,c);}],Sb,"java.util.Map",E,[],0,0,[],Gb,"java.lang.Cloneable",
E,[],0,0,[],Lc,"org.teavm.jso.impl.JS",E,[],0,0,[],Cb,"java.lang.CharSequence",E,[],0,0,[],Qb,"org.teavm.jso.dom.events.LoadEventTarget",E,[L],0,0,[],Uc,"java.lang.StringIndexOutOfBoundsException",Hb,[],0,0,["a",function(){Nf(this);}],Bb,"java.io.FilterOutputStream",K,[],0,0,["sb",function(b){Gf(this,b);}],U,"java.io.Serializable",E,[],0,0,[],Lb,"java.util.Map$Entry",E,[],0,0,[],X,"java.util.MapEntry",E,[Lb,Gb],0,0,["Z",function(b,c){Je(this,b,c);}],Xc,"java.util.HashMap$HashEntry",X,[],0,0,["W",function(b,
c){Se(this,b,c);}],J,"java.lang.AbstractStringBuilder",E,[U,Cb],0,J_$callClinit,["a",function(){Jc(this);},"c",function(b){Dc(this,b);}],Yb,"java.lang.Appendable",E,[],0,0,[],Pc,"java.lang.StringBuilder",J,[Yb],0,0,["a",function(){Cf(this);}],Eb,"java.io.InputStream",E,[Z],0,0,["a",function(){Fe(this);}],Hc,"java.lang.ConsoleInputStream",Eb,[],0,0,["a",function(){Qd(this);}],Ib,"java.lang.reflect.AnnotatedElement",E,[],0,0,[],Ub,"java.util.Comparator",E,[],0,0,[],Zc,"$$LAMBDA0$$",E,[Ub],0,0,["a",function(){
Wd(this);}],Tb,"org.teavm.jso.dom.events.FocusEventTarget",E,[L],0,0,[],Rb,"org.teavm.jso.dom.events.MouseEventTarget",E,[L],0,0,[],Pb,"org.teavm.jso.dom.events.KeyboardEventTarget",E,[L],0,0,[],Jb,"org.teavm.jso.browser.WindowEventTarget",E,[L,Tb,Rb,Pb,Qb],0,0,[],Y,"java.util.AbstractMap",E,[Sb],0,0,["a",function(){Nd(this);}],Zb,"java.util.HashMap",Y,[Gb,U],0,0,["ib",function(b){return Te(this,b);},"a",function(){Sd(this);},"c",function(b){Vd(this,b);},"u",function(b,c){Me(this,b,c);},"gb",function(){Md(this);
},"Bb",function(b){return Bf(this,b);},"Db",function(b){return Id(this,b);},"A",function(b,c,d){return Jd(this,b,c,d);},"g",function(){return Ue(this);},"qb",function(b,c){return Pd(this,b,c);},"db",function(b,c){return Ce(this,b,c);},"hb",function(b,c,d){return Jf(this,b,c,d);},"e",function(b){Ae(this,b);},"fb",function(){Xd(this);}],Vb,"org.teavm.jso.browser.StorageProvider",E,[],0,0,[],Mb,"org.teavm.jso.core.JSArrayReader",E,[M],0,0,[],Mc,"org.teavm.jso.browser.Window",E,[M,Jb,Vb,Mb],0,0,["l",function(b,
c){return Ld(this,b,c);},"ob",function(b,c,d){return Fd(this,b,c,d);},"ub",function(b){return Lf(this,b);},"k",function(b,c){return De(this,b,c);},"lb",function(b){return Ve(this,b);},"tb",function(){return Gd(this);},"rb",function(b,c,d){return Ee(this,b,c,d);}],Vc,"org.teavm.platform.Platform",E,[],0,0,[],Fb,"java.lang.Comparable",E,[],0,0,[],T,"java.nio.charset.Charset",E,[Fb],0,T_$callClinit,["R",function(b,c){Ec(this,b,c);}],W,"java.lang.IllegalArgumentException",P,[],0,0,["a",function(){Ke(this);}],Wc,
"java.nio.charset.IllegalCharsetNameException",W,[],0,0,["b",function(b){Od(this,b);}],Ab,"java.lang.String",E,[U,Fb,Cb],0,Ab_$callClinit,["L",function(b){Bc(this,b);},"v",function(b){return Ff(this,b);},"zb",function(){return C(this);},"mb",function(){return Bd(this);},"xb",function(b,c,d,e){D(this,b,c,d,e);},"pb",function(b){return Mf(this,b);},"t",function(){return Xe(this);},"m",function(){return G(this);}],Cc,"java.lang.NoClassDefFoundError",Q,[],0,0,[],Ic,"java.io.PrintStream",Bb,[],0,0,["Gb",function(b,
c){Pe(this,b,c);}],Nc,"com.manu.Client",E,[],0,0,[],Kc,"java.lang.NoSuchMethodError",O,[],0,0,["b",function(b){Td(this,b);}],Sc,"java.lang.ConsoleOutputStreamStderr",K,[],0,0,["a",function(){We(this);}],Qc,"java.nio.charset.impl.UTF8Charset",T,[],0,0,["a",function(){Be(this);}],Gc,"java.lang.Class",E,[Ib],0,0,["U",function(b){Af(this,b);}]]);
$rt_stringPool(["main","UTF-8"]);
var main=Qf;
(function(){var c;c=Mc.prototype;c.removeEventListener=c.l;c.removeEventListener=c.ob;c.dispatchEvent=c.ub;c.getLength=c.tb;c.addEventListener=c.k;c.get=c.lb;c.addEventListener=c.rb;})();
